    ...
    <div className="relative w-full min-h-screen bg-gradient-to-br from-[#18181b] via-[#09090b] to-[#000000] pt-32 pb-20 px-4">
      ...
      <main className="relative z-10 max-w-5xl mx-auto bg-black/60 backdrop-blur-md rounded-3xl p-8 sm:p-12 shadow-2xl text-white">
        <motion.h1 
          ...
          className="text-4xl sm:text-5xl font-extrabold text-center mb-12 text-amber-400 tracking-wide"
        >
          ...
          {questions.map((item, ind) => {
            return (
              <motion.div
                ...
                transition={{ duration: 0.4, delay: (ind % 4) * 0.05 }}
              >
                <Accordion type="single" collapsible className="bg-white/5 border border-white/10 rounded-2xl px-6 py-1 sm:py-2 hover:bg-white/10 transition-all duration-300">
