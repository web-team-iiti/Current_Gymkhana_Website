          ...
          <div className="flex bg-[#abdbe3] flex-col justify-center max-w-xs p-6 my-2 shadow-md rounded-xl sm:px-12  border-4 border-blue-800 hover:border-white justify-self-center max-[469px]:w-[80%]  ">
            ...
            <div className="space-y-4 text-center divide-y divide-gray-700">
              ...
              <div className="flex justify-center pt-2 space-x-4 align-center text-blue-900">
                ...
                <a
                  rel="noopener noreferrer"
                  href="mailto:president.sg@iiti.ac.in"
                  aria-label="Email"
                  className="p-2 rounded-md "
                  target="_blank"
                >
          ...
          <div className="flex bg-[#abdbe3]  flex-col justify-center max-w-xs p-6 my-2 shadow-md rounded-xl sm:px-12  border-4 border-blue-800 hover:border-white justify-self-center max-[469px]:w-[80%] ">
            ...
            <div className="space-y-4 text-center divide-y divide-gray-700">
              ...
              <div className="flex justify-center pt-2 space-x-4 align-center text-blue-900">
                ...
                <a
                  rel="noopener noreferrer"
                  href="mailto:gs.culturals@iiti.ac.in"
                  aria-label="Email"
                  className="p-2 rounded-md "
                  target="_blank"
                >
          ...
          <div className="flex bg-[#abdbe3]  flex-col justify-center max-w-xs p-6 my-2 shadow-md rounded-xl sm:px-12  border-4 border-blue-800 hover:border-white justify-self-center max-[469px]:w-[80%] ">
            ...
            <div className="space-y-4 text-center divide-y divide-gray-700">
			  ...
			  <div className="flex justify-center pt-2 space-x-4 align-center text-blue-900">
                ...
                <a
                  rel="noopener noreferrer"
                  href="mailto:gs.acad.ug@iiti.ac.in"
                  target="_blank"
                  aria-label="Email"
                  className="p-2 rounded-md "
                >
          ...
          <div className="flex bg-[#abdbe3]  flex-col justify-center max-w-xs p-6 my-2 shadow-md rounded-xl sm:px-12  border-4 border-blue-800 hover:border-white justify-self-center max-[469px]:w-[80%]">
            ...
            <div className="space-y-4 text-center divide-y divide-gray-700">
              ...
              <div className="flex justify-center pt-2 space-x-4 align-center text-blue-900">
                ...
                <a
                  rel="noopener noreferrer"
                  href="mailto:gs.hostel@iiti.ac.in"
                  target="_blank"
                  aria-label="Email"
                  className="p-2 rounded-md "
                >
          ...
          <div className="flex bg-[#abdbe3] flex-col justify-center max-w-xs p-6 my-2 shadow-md rounded-xl sm:px-12  border-4 border-blue-800 hover:border-white justify-self-center max-[469px]:w-[80%]">
            ...
            <div className="space-y-4 text-center divide-y divide-gray-700">
              ...
              <div className="flex justify-center pt-2 space-x-4 align-center text-blue-900">
                ...
                <a
                  rel="noopener noreferrer"
                  href="mailto:gs.dining@iiti.ac.in"
                  target="_blank"
                  aria-label="Email"
                  className="p-2 rounded-md "
                >
          ...
          <div className="flex bg-[#abdbe3]  flex-col justify-center max-w-xs p-6 my-2 shadow-md rounded-xl sm:px-12  border-4 border-blue-800 hover:border-white justify-self-center max-[469px]:w-[80%] ">
            ...
            <div className="space-y-4 text-center divide-y divide-gray-700">
              ...
              <div className="flex justify-center pt-2 space-x-4 align-center text-blue-900">
                ...
                <a
                  rel="noopener noreferrer"
                  href="mailto:gs.scitech@iiti.ac.in"
                  target="_blank"
                  aria-label="Email"
                  className="p-2 rounded-md "
                >
          ...
          <div className="flex bg-[#abdbe3]  flex-col justify-center max-w-xs p-6 my-2 shadow-md rounded-xl sm:px-12  border-4 border-blue-800 hover:border-white justify-self-center max-[469px]:w-[80%]">
            ...
            <div className="space-y-4 text-center divide-y divide-gray-700">
			  ...
			  <div className="flex justify-center pt-2 space-x-4 align-center text-blue-900">
                ...
                <a
                  rel="noopener noreferrer"
                  href="mailto:gs.acad.pg@iiti.ac.in"
                  target="_blank"
                  aria-label="Email"
                  className="p-2 rounded-md "
                >
